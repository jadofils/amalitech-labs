...
public class AuthPageController {
    ...
    public void initialize() {
        if (regRole != null) {
            regRole.getItems().addAll("Doctor", "Nurse", "Receptionist", "Administrator");
        }
    ...
    private void handleRegister() {
        ...
        System.out.println("Registered: " + regEmail.getText());
        navigateToDashboard();
    }
    ...
    private void navigateToDashboard() {
        try {
            FXMLLoader loader = new FXMLLoader(
                getClass().getResource("/hospital/management/fxml/dashboard.fxml")
            );
